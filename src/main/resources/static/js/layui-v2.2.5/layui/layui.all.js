...
layui.define("jquery", function (i) {
    ...
    s.prototype.set = function (i) {
        ...
        var e = ".layui-tab-title", l = t(".layui-tab[lay-filter=" + i + "]"), n = l.children(e), s = n.children(".layui-tab-bar"), o = l.children(".layui-tab-content"),
    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child", h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
        tabClick: function (i, a, s, o) {
            o = o || {};
            var c = s || t(this), a = a || c.parent().children("li").index(c), r = o.headerElem ? c.parent() : c.parents(".layui-tab").eq(0),
                u = o.bodyElem ? t(o.bodyElem) : r.children(".layui-tab-content").children(".layui-tab-item"), d = c.find("a"), h = r.attr("lay-filter");
            ...
            var n = a || t(this).parent(), s = n.index(), o = n.parents(".layui-tab").eq(0), c = o.children(".layui-tab-content").children(".layui-tab-item"),
                r = o.attr("lay-filter");
            ...
            t(".layui-tab").each(function () {
                var s = t(this), o = s.children(".layui-tab-title"), c = (s.children(".layui-tab-content").children(".layui-tab-item"), 'lay-stope="tabmore"'),
            ...
            var i = t(this), a = i.find(".layui-colla-icon"), l = i.siblings(".layui-colla-content"), s = i.parents(".layui-collapse").eq(0), o = s.attr("lay-filter"),
            ...
            l[c ? "addClass" : "removeClass"](n), a.html(c ? "&#xe61a;" : "&#xe602;"), layui.event.call(this, e, "collapse(" + o + ")", {title: i, content: l, show: c})
        }
    };
...
layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        var e = this, t = e.config, n = e.elemFile = i(['<input class="' + u + '" type="file" name="' + t.field + '"', t.multiple ? " multiple" : "", ">"].join("")),
            o = t.elem.next();
        ...
        var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
            ...
            layui.each(a, function (e, a) {
                ...
                r.append(l.field, a), layui.each(l.data, function (e, i) {
                    ...
                    url: l.url, type: l.method, data: r, contentType: !1, processData: !1, dataType: "json", success: function (i) {
                        t++, d(e, i), u()
                    }, error: function () {
...
layui.define("layer", function (e) {
    "use strict";
    var t = layui.$, i = layui.layer, a = layui.hint(), n = layui.device(), l = "form", r = ".layui-form", s = "layui-this", o = "layui-hide", u = "layui-disabled",
        c = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "必填项不能为空"],
    ...
    var d = function () {
        var e = t(this), a = f.config.verify, s = null, o = "layui-form-danger", u = {}, c = e.parents(r), d = c.find("*[lay-verify]"), y = e.parents("form")[0],
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, o = layui.hint(), r = layui.device(), d = {
        ...
        }, s = "table", u = ".layui-table", h = "layui-hide", f = "layui-none", y = "layui-table-view", p = ".layui-table-header", m = ".layui-table-body", v = ".layui-table-main",
        g = ".layui-table-fixed", x = ".layui-table-fixed-l", b = ".layui-table-fixed-r", k = ".layui-table-tool", C = ".layui-table-page", w = ".layui-table-sort",
...
layui.define("jquery", function (e) {
    ...
    var t = layui.$, i = {
        fixbar: function (e) {
            ...
            var o = this, a = "function" == typeof t, r = new Date(e).getTime(), n = new Date(!t || a ? (new Date).getTime() : t).getTime(), l = r - n,
            ...
            var i = this, o = new Date(e || new Date), a = [i.digit(o.getFullYear(), 4), i.digit(o.getMonth() + 1), i.digit(o.getDate())],
